...
![Figure 5](images/complete_ch.jpg)

##### Imputed record analysis Switzerland

![Figure 6](images/imputed_ch.png)

##### Complete record analysis South Africa

![Figure 7](images/complete_rsa.jpg)

##### Imputed record analysis Switzerland

![Figure 8](images/imputed_rsa.png)

#### Aalen-Johansen

![Figure 9: The cumulative incidence rates for time to first tuberculosis incidence after ART initiation were calculated using Aalen-Johansen method, adjusting for all-cause death as a competing risk. Stratified by cohort, Khayelitsha (green) and SHCS (orange).](images/aj.png)
