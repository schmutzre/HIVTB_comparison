...
fill_values_for_id <- function(patient_data, global_grid) {
  ...
  # Assuming md_intvstCH is defined elsewhere in your code
  ...
  results <- left_join(results, unique_vals, by = character())
...
gridCH <- seq(from = -60, to = 360, by = md_intvstCH)
...
```{r cache=TRUE, echo=FALSE}
md_intvstRSA <- intervisit_Md(lab_rawRSA) 
